...
void main() async{
  ...
  await Firebase.initializeApp(options: kIsWeb || Platform.isAndroid ? FirebaseOptions( //This basically checks whether we are on Web or Android App
      apiKey: "AIzaSyCFQ-cA2ZCcNxK3L-fePb-ABnLCno_AzYA", //Getting all these Firebase Options from Firebase when I was registering or linking this Web App with my Firebase.
      ...
      : null);  //If we are on Web App run all these Firebase Options else 'null'.
