...
class VendorListWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final Stream<QuerySnapshot> customersStream = FirebaseFirestore.instance.collection('vendors').snapshots();
            ...
            itemBuilder: (context, index) {
              ...
              return Row(
                children: [
                  ...
                  VendorData(Text('${customer['locality']} ${customer['city']} ${customer['state']} ${customer['pinCode']}'), 3),
