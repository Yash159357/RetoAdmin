...
class _MainScreenState extends State<MainScreen> {
  ...
  Widget _selectedScreen = CustomersScreen(); //By default it is set to VendorsScreen, i.e., when our Admin Panel will open first this side bar screen will appear.


  //Creating a function that will change our Screens on clicking that respective Side Bar Screen Button.
  screenSelector(item) {
    switch(item.route) { //Whichever particular Option we will click in Side Bar will be counted as Item here. Hence if our item.route matches with that id of that screen then we will display that screen.
  ...
  Widget build(BuildContext context) {
    return AdminScaffold(
      ...
      appBar: AppBar(
        ...
        backgroundColor: Colors.blue, //Color of our Admin Panel App Bar
      ...
      sideBar: SideBar(
        ...
        items: const [
          ...
          AdminMenuItem(
            title: 'Customers',
            route: CustomersScreen.id, //Passing the id which we mentioned on every Side Bar Screen for Navigation
          ...
          AdminMenuItem(
            title: 'Vendors',
            route: VendorsScreen.id, //Passing the id which we mentioned on every Side Bar Screen for Navigation
          ...
          AdminMenuItem(
            title: 'Orders',
            route: OrdersScreen.id, //Passing the id which we mentioned on every Side Bar Screen for Navigation
          ...
          AdminMenuItem(
            title: 'Categories',
            route: CategoryScreen.id, //Passing the id which we mentioned on every Side Bar Screen for Navigation
            icon: Icons.category,
          ),
          ...
          AdminMenuItem(
            ...
            route: UploadBannerScreen.id, //Passing the id which we mentioned on every Side Bar Screen for Navigation
          ...
          AdminMenuItem(
            ...
            route: ProductsScreen.id, //Passing the id which we mentioned on every Side Bar Screen for Navigation
            icon: CupertinoIcons.shopping_cart,
          ),

        ], //End of Items Section in Side Bar

        selectedRoute: CustomersScreen.id, //This will highlight the item in Side Bar that we made default at the top. When we change our Default Screen change this as well.

        onSelected: (item) { //This will store which item in Side Bar we clicked.
          screenSelector(item);
        },
